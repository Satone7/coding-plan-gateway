...
export const mockQuotaConfigs: Record<string, QuotaConfig> = {
  '5h': { limit: 100, period: { type: '5h', windowHours: 5, sliding: true } },
  weekly: { limit: 500, period: { type: 'weekly', weekday: 1 } },
  monthly: { limit: 1000, period: { type: 'monthly' } },
  total: { limit: 5000, period: { type: 'total' } },
};
...
export function createMockPlans(): CodingPlan[] {
  ...
  return [
    ...
    },
    {
      ...
      quota: { limit: 2000, period: { type: 'monthly' } },
      timeout: 60,
      status: 'active',
      createdAt: now,
      updatedAt: now,
    ...
    },
    {
      ...
      quota: { limit: 10, period: { type: 'total' } },
      timeout: 30,
      status: 'exhausted',
      createdAt: now,
      updatedAt: now,
